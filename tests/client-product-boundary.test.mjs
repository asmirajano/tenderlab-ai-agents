...
test("prepares an independent TenderApps build target", async () => {
  ...
  if (configuredTarget) assert.ok(Array.isArray(configuredTarget));
  assert.equal(typeof deployWorkflow, "string");
});
