...
export const case1Chronology: CaseChronologyEvent[] = [
  {
    ...
    agents: ["Tender Source Ingestion Agent", "Tender Classification Agent", "Audit & Version Control Agent"],
  ...
  },
  {
    ...
    narrative: "Все 27 файлов загружаются из первичных источников, получают checksum, версию и индекс. Пакет раскладывается на один лот, 68 BOQ-позиций, 180 точек поставки и 27 обязательных форм. Основные документы цифровые и англоязычные, поэтому OCR & Language Agent не запускается; Amendment & Change Agent остаётся в резерве на случай addendum.",
    agents: ["Document Intake Agent", "Tender Structure Agent", "Audit & Version Control Agent", "OCR & Language Agent — резерв", "Amendment & Change Agent — резерв"],
  ...
  },
  {
    ...
    agents: ["Requirement Parser Agent", "Eligibility & Qualification Agent", "Evaluation Criteria Agent", "Deliverables & Forms Agent", "Strict-Spec Agent", "Ambiguity & Clarification Agent — резерв"],
  ...
  },
  {
    ...
    agents: ["Company-to-Tender Match Score Agent", "Solution-Based Matching Agent", "Gap Analysis Agent", "Evidence & Provenance Agent"],
  ...
  },
  {
    ...
    agents: ["TenderScore / Bid-No-Bid Agent", "Capacity & Execution Agent", "Commercial Attractiveness Agent", "Risk & Integrity Agent", "Human Approval Agent"],
  ...
  },
  {
    ...
    narrative: "Так как Anatolia сама производит весь lot, внешние product suppliers, RFQ и supplier quotation chain не нужны. Но tender требует монтаж и гарантийные выезды в Грузии. Local Representation Agent формирует shortlist из трёх сервисных компаний; выбранный кандидат из Тбилиси проверяется по команде, географии, SLA и способности обслужить 180 школ.",
    agents: ["Local Representation Agent", "Partner Capability Graph Agent", "Participation Route Agent", "Company Verification Agent"],
  ...
  },
  {
    ...
    agents: ["Solution Architecture Agent", "Capacity & Execution Agent", "Execution & Logistics Agent", "Product & Capability Agent"],
  ...
  },
  {
    ...
    agents: ["Tender Alert & Deadline Agent", "Ambiguity & Clarification Agent — резерв", "Amendment & Change Agent — резерв"],
  ...
  },
  {
    ...
    agents: ["Compliance Matrix Agent", "Technical Compliance Agent", "Commercial Compliance Agent", "Credentials & Experience Agent", "Evidence & Provenance Agent"],
  ...
  },
  {
    ...
    agents: ["Proposal Strategy Agent", "Technical Proposal Agent", "Commercial Proposal Agent", "Credentials & Experience Agent"],
  ...
  },
  {
    ...
    agents: ["Clarification Response Agent", "Evidence & Provenance Agent", "Legal & Contract Review Agent", "Human Approval Agent"],
  ...
  },
  {
    ...
    agents: ["Award & Contract Agent", "Tender Alert & Deadline Agent", "Legal & Contract Review Agent", "Human Approval Agent"],
  ...
  },
  {
    ...
    agents: ["Award & Contract Agent", "Legal & Contract Review Agent", "Execution & Logistics Agent", "Payment & Contract Administration Agent"],
  ...
  },
  {
    ...
    agents: ["Execution & Logistics Agent", "Payment & Contract Administration Agent", "Outcome Learning Agent", "Tender Knowledge Graph Agent", "Audit & Version Control Agent"],
...
export const case1Engagements: CaseAgentEngagement[] = [
  ...
  { agentId: 11, status: "not-involved", stageId: "solution", when: "Не запускается", why: "Компания производит предмет закупки сама; отдельная tender-specific база внешних поставщиков не нужна.", coveredBy: "Product & Capability Agent и Capacity & Execution Agent подтверждают собственное производство." },
  ...
  { agentId: 40, status: "not-involved", stageId: "solution", when: "Не запускается", why: "Нужен именно локальный сервисный представитель, поэтому широкий международный поиск партнёров дублировал бы более точный маршрут.", coveredBy: "Local Representation Agent выполняет узкий поиск; Partner Capability Graph Agent проверяет найденного кандидата." },
  ...
  { agentId: 60, status: "not-involved", stageId: "evaluation", when: "Не запускается", why: "Открытая процедура товаров не предусматривает презентацию или переговоры до award.", coveredBy: "Clarification Response Agent отвечает только на формальный письменный запрос комиссии." },
  ...
  { agentId: 62, status: "required", stageId: "delivery", when: "После подписания контракта", why: "Контракт охватывает производство, QC, шесть волн поставки и монтаж в 180 школах.", input: "Signed contract, solution architecture, capacity plan и site schedule.", output: "План исполнения и live status по производству, доставке, монтажу и warranty handover.", next: "Payment & Contract Administration Agent и Outcome Learning Agent." },
