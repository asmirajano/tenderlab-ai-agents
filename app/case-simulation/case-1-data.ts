...
export const legacyCase1Chronology: CaseChronologyEvent[] = [
  ...
  },
  {
    ...
    agents: ["TENDER LOGISTICS COST", "Pricing & BOQ Agent", "Commercial Attractiveness Agent", "Commercial Compliance Agent"],
...
export const case1Engagements: CaseAgentEngagement[] = [
  ...
  { agentId: 46, status: "not-involved", stageId: "solution", when: "Не запускается", why: "Нет нескольких внешних supplier quotations для нормализации.", coveredBy: "TENDER LOGISTICS COST использует внутренние калькуляции и подтверждённые логистические ставки." },
