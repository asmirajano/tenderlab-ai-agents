...
const runSteps: RunStep[] = [
  {
    ...
    phase: "Маршрут",
    action: "Формирует маршрут кейса, зависимости и точки контроля.",
    received: "Профиль мебельной компании и ссылка на закупку GE-MES-2026-017.",
    output: "Создан маршрут из 20 Main agents с двумя точками управленческого решения.",
    handoff: "Контекст компании, тендера и план выполнения.",
  },
  {
    id: 6,
