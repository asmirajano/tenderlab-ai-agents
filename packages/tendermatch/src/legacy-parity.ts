...
export const tenderBoostParityManifest: LegacyParityItem[] = [
  ...
  item("interaction-radar-marker", "interaction", "Map marker selection", "Geographic marker selection", "preserved", "Pointer or keyboard selection updates the exact detail panel."),
