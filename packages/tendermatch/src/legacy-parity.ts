...
export const tenderBoostParityManifest: LegacyParityItem[] = [
  ...
  item("nav-supplier-profiles", "navigation", "03 Suppliers / Profiles", "Suppliers / Profiles", "truth-corrected", "The ten frozen profiles remain historical regression fixtures; all 100 policy-corrected Neon profiles are reachable at runtime."),
  ...
  item("content-supplier-directory", "content", "Supplier directory", "Supplier directory", "truth-corrected", "All 100 policy-corrected profiles are shown with source readiness states; no legacy score or readiness percentage is reused."),
  ...
  item("content-full-matrix", "content", "10 × 16 matrix", "Runtime-derived 100 × 60 evaluation matrix", "truth-corrected", "All 6,000 pairs are evaluated; only policy-eligible technical overlaps receive an exploratory estimate and all others remain MISSING."),
  ...
  item("content-evidence-profile", "content", "Supplier identity and evidence", "Supplier identity and evidence", "truth-corrected", "Safe non-contact evidence is loaded on demand from the read-only v2.1 contract; raw source content is not exposed."),
  ...
  item("data-suppliers", "data", "10 frozen supplier records", "100 policy-corrected Neon supplier profiles", "truth-corrected", "The frozen JSON blob remains historical regression evidence and does not power runtime views."),
  ...
  item("data-unassessed", "data", "142 implicit zero pairs", "Policy-gated 6,000-pair evaluation inventory", "truth-corrected", "Numeric exploratory technical fit is emitted only above the minimum evidence threshold; every other completed evaluation remains MISSING and a future evaluated zero remains distinguishable."),
