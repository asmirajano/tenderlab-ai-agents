...
export const tenderBoostParityManifest: LegacyParityItem[] = [
  ...
  item("nav-matrix-full", "navigation", "05 Full Match Matrix", "Match Matrix / Portfolio", "truth-corrected", "Every cell shows the Formula v1.1 coverage-adjusted Pair Score; criterion-level evidence gaps remain visible in drill-down."),
  ...
  item("content-tender-radar-kpis", "content", "Tender radar KPIs", "Current pilot KPI summary", "truth-corrected", "Counts derive from active inputs and distinguish numeric preliminary results, blocked pairs, unassessed pairs and human decisions."),
  ...
  item("content-full-matrix", "content", "10 × 16 matrix", "Runtime-derived 17 × 60 evaluation matrix", "truth-corrected", "All 1,020 pairs expose a Formula v1.1 numeric Pair Score, Data Coverage and Evidence Confidence without assigning a Match/Non-match verdict."),
  item("content-tender-ranked-list", "content", "Tender-first supplier ranking", "Tender-first score list", "truth-corrected", "Tender-first review ranks the coverage-adjusted Pair Score while keeping coverage, confidence and evidence gaps separate."),
  item("content-supplier-ranked-list", "content", "Supplier-first tender ranking", "Supplier-first score list", "truth-corrected", "Supplier-first review preserves criterion-level MISSING evidence and recomputes deadline freshness from the supplied clock."),
  ...
  item("interaction-matrix-cell", "interaction", "Matrix-cell drill-down", "Matrix-cell drill-down", "preserved", "Opens the selected explicit pair, including zero-score pairs and their missing-evidence explanation."),
  ...
  item("state-empty-priority", "state", "No priority matches", "No match threshold configured", "truth-corrected", "Score bands organize review only; they are not Match/Non-match decisions."),
  ...
  item("data-unassessed", "data", "142 implicit zero pairs", "Formula v1.1 1,020-pair numeric score inventory", "truth-corrected", "Every pair receives a coverage-adjusted 0–100 score. Unknown criteria remain MISSING, contribute zero points and reduce coverage; no Match threshold is applied."),
