...
export const tenderBoostParityManifest: LegacyParityItem[] = [
  ...
  item("content-full-matrix", "content", "10 × 16 matrix", "Runtime-derived 17 × 60 evaluation matrix", "truth-corrected", "All 1,020 pairs expose Formula v1.0 status; numeric fit, coverage, confidence, blocked and unassessed states remain distinct."),
  item("content-tender-ranked-list", "content", "Tender-first supplier ranking", "Tender-first review list", "truth-corrected", "Tender-first review ranks by Pair Status and score without treating unassessed as low-scoring."),
  item("content-supplier-ranked-list", "content", "Supplier-first tender ranking", "Supplier-first review list", "truth-corrected", "Supplier-first review preserves zero-versus-MISSING semantics and recomputes deadline freshness from the supplied clock."),
  ...
  item("state-empty-priority", "state", "No priority matches", "No threshold-qualified candidates", "truth-corrected", "Unassessed, blocked and no-match results are not presented as low-priority candidates."),
  ...
  item("data-unassessed", "data", "142 implicit zero pairs", "Formula v1.0 1,020-pair result inventory", "truth-corrected", "Unknown components remain MISSING, a supported fit zero stays numeric, and every pair has an explicit status, coverage and confidence result."),
