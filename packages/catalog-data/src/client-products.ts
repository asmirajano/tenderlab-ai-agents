...
export const clientProducts: ClientProduct[] = [
  ...
  },
  {
    ...
    family: "Tender Apps",
    name: "TenderMatch",
    descriptor: "TenderMatch pilot with 60 current-at-extraction Central Asia tenders, 100 under-review supplier profiles, and evidence-gated exploratory Company × Tender evaluation",
    surfaceStatus: "Local controlled pilot · read-only supplier API · human disposition",
    dataNotice: "60-tender snapshot · 100 policy-corrected supplier profiles · 6,000 completed evaluations with numeric exploratory fit only above the evidence gate · no direct browser database connection",
    status: "pilot",
