...
export const clientProducts: ClientProduct[] = [
  ...
  },
  {
    ...
    family: "Tender Apps",
    name: "TenderMatch",
    descriptor: "TenderMatch current Central Asia tender pilot with explicit MISSING Company × Tender evaluations",
    surfaceStatus: "Read-only pilot snapshot · evidence review and human disposition",
    dataNotice: "Current-at-extraction Central Asia pilot · all pairs unassessed/MISSING · no live browser database connection",
    status: "mvp-simulation",
