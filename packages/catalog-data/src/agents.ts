...
const agentDefinitions: AgentDefinitionSeed[] = [
  ...
  { id: 8, name: "Company Verification Agent", description: "Проверяет компанию, производство, опыт и source-traceable финансовые факты.", layer: "company", output: { primary: "Верифицированное досье компании", artifacts: ["Legal identity", "Проверка производства", "Подтверждённые референсы", "Проверенные balance-sheet records"], consumers: "Company Profile · Eligibility · Match Score" } },
  ...
  { id: 46, name: "Quotation Normalization Agent", description: "Приводит предложения к единому сравнению.", layer: "solution", output: { primary: "Сопоставимая таблица котировок", artifacts: ["Normalized unit cost", "Incoterms and lead time", "Deviations and exclusions"], consumers: "TENDER LOGISTICS COST · Pricing" } },
  ...
  { id: 50, name: "TENDER LOGISTICS COST", description: "Считает полную стоимость поставки и исполнения.", layer: "bid", output: { primary: "Модель полной стоимости поставки", artifacts: ["Unit и total costs", "Фрахт, пошлины, налоги", "Сценарные допущения"], consumers: "Pricing & BOQ · Commercial Proposal" } },
