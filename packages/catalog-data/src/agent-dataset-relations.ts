...
const relations: Record<number, RelationSeed[]> = {
  ...
  13: [["TENDER-NOTICES", "creates-record", ["normalized notice", "source URL", "publication metadata", "source item type and confidence", "version and deduplication keys"]], ["RAW-ARCHIVE", "appends-event", ["original response", "attachments", "hashes", "canonical source reference"]], ["PROVENANCE-RIGHTS", "enriches-record", ["source", "licence", "ingestion method"]]],
