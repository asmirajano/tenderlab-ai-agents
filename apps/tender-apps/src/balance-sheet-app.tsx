    ...
    return (
      <main className="bs-page bs-client-start">
        ...
        <ClientProductManifesto
          ...
          promise={<>Upload financial statements. TenderBalance prepares reviewable FIN-1 and FIN-2 forms.</>}
          roleCallout={(
            <AgentRoleCallout
              ...
              subtitle="Traceable FIN-1 and FIN-2 preparation"
          ...
          input={(
            <article className="bs-manifesto-input">
              ...
              <div className="bs-raw-document-stack" aria-label="Examples of raw balance-sheet inputs">
                <div><span>PDF</span><b>Balance Sheet.pdf</b></div>
                <div><span>SCAN</span><b>Statement 2024.jpg</b></div>
                <div><span>PDF</span><b>Comparative 2025.pdf</b></div>
              </div>
          ...
          output={(
            <article className="bs-result-receipt">
              <div className="bs-manifesto-label"><span>03</span><b>WHAT YOU RECEIVE</b><em>ILLUSTRATIVE</em></div>
              <div className="bs-fin-output-stage" aria-label="Illustrative output: two reviewable, source-linked tender financial forms">
                <article className="bs-fin-form-card fin-one">
                  <header><span>FIN-1</span><i>REVIEW</i></header>
                  <strong>Historical Financial<br />Performance</strong>
                  <div aria-hidden="true"><span /><span /><span /></div>
                  <footer><b>2025 · 2024</b><small>✓ SOURCE-LINKED</small></footer>
                </article>
                <article className="bs-fin-form-card fin-two">
                  <header><span>FIN-2</span><i>REVIEW</i></header>
                  <strong>Average Annual<br />Turnover</strong>
                  <div aria-hidden="true"><span /><span /><span /></div>
                  <footer><b>CALCULATED</b><small>✓ TRACEABLE</small></footer>
                </article>
              </div>
              <p className="bs-fin-output-truth"><b>FIN-1 + FIN-2</b><span>Reviewable · not approved</span></p>
            </article>
          )}
          actions={(
            <>
              <button className="bs-primary-action" onClick={startNewAnalysis} type="button">Prepare tender forms <span aria-hidden="true">→</span></button>
        ...
        <PracticalAgentOverviewBoundary as="details" className="bs-landing-details" productId="product:TA-BALANCE">
          <summary>How it works and scope</summary>
          <div className="bs-client-journey" aria-label="How TenderBalance works">
            <article><span>01</span><strong>Upload statements</strong><p>Add financial statements.</p></article>
            <article><span>02</span><strong>The agent works</strong><p>Digitizes, reconciles, and maps eligible evidence.</p></article>
            <article><span>03</span><strong>Receive forms</strong><p>FIN-1 and FIN-2 save to the Case for review.</p></article>
            <article><span>04</span><strong>Optional audit</strong><p>Source trace, corrections, comparison, and approval remain optional.</p></article>
          </div>
          <section className="bs-trust-boundary">
            ...
            <p>Original reported values stay separate from corrections; unavailable evidence stays MISSING. TenderBalance does not assess financial health, supplier suitability, or tender eligibility.</p>
